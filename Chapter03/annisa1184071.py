# -*- coding: utf-8 -*-
"""
Created on Wed Apr  7 11:02:24 2021
...
def preparation():
    dfs = pandas.read_csv('Chapter01/dataset/tweet.csv', sep= ',')
    ...
    dfs_train = dfs[:15000]
    dfs_test = dfs[15000:]
    dfs_train_attribute = cv.fit_transform(dfs_train['tweet'])
    dfs_train_win = dfs_train['label']
    dfs_test_attribute = cv.transform(dfs_test['tweet'])
